...
const QUIZZES: Quiz[] = [
  {
    ...
    questions: [
      ...
      { id: 6, text: "Упростите: 3x + 2x − x", options: ["3x", "4x", "5x", "6x"], correct: 1 },
      { id: 7, text: "Решите: 4(2x + 1) = 20", options: ["x = 2", "x = 2.5", "x = 4", "x = 5"], correct: 0 },
      { id: 8, text: "Чему равно x: x² = 49?", options: ["x = 7", "x = ±7", "x = 24.5", "x = 98"], correct: 1 },
      { id: 9, text: "Найдите x: 3x − 4 = 2x + 6", options: ["x = 2", "x = 10", "x = 5", "x = 8"], correct: 1 },
      { id: 10, text: "Решите: (x + 3)/2 = 5", options: ["x = 4", "x = 7", "x = 10", "x = 13"], correct: 1 },
    ],
  },
  {
    id: 2,
    ...
    questions: [
      ...
      { id: 6, text: "Какая часть речи обозначает признак предмета?", options: ["Глагол", "Наречие", "Имя прилагательное", "Союз"], correct: 2 },
      { id: 7, text: "«Над, под, за» — это...", options: ["Союзы", "Частицы", "Предлоги", "Местоимения"], correct: 2 },
      { id: 8, text: "Какое слово является глаголом?", options: ["Синева", "Синий", "Синеть", "Синевато"], correct: 2 },
      { id: 9, text: "«И, но, однако» — это...", options: ["Предлоги", "Союзы", "Частицы", "Местоимения"], correct: 1 },
      { id: 10, text: "Слово «три» в предложении «три доски» — это...", options: ["Прилагательное", "Существительное", "Числительное", "Наречие"], correct: 2 },
    ],
  },
  {
    id: 3,
    ...
    questions: [
      ...
      { id: 6, text: "Какой материк был открыт последним?", options: ["Австралия", "Антарктида", "Америка", "Африка"], correct: 1 },
      { id: 7, text: "Как называлось первое кругосветное путешествие по имени командира?", options: ["Экспедиция Колумба", "Экспедиция Магеллана–Элькано", "Экспедиция Дрейка", "Экспедиция Кука"], correct: 1 },
      { id: 8, text: "Кто открыл Австралию для европейцев?", options: ["Джеймс Кук", "Абел Тасман", "Виллем Янсзон", "Педру Кабрал"], correct: 2 },
      { id: 9, text: "Какой океан пересёк Магеллан первым из европейцев?", options: ["Атлантический", "Индийский", "Тихий", "Северный Ледовитый"], correct: 2 },
      { id: 10, text: "В каком году была открыта Антарктида?", options: ["1788", "1820", "1865", "1900"], correct: 1 },
    ],
  },
  {
    id: 4,
    ...
    timeLimit: 240,
    questions: [
      { id: 1, text: "Что измеряет термометр?", options: ["Давление", "Температуру", "Скорость", "Массу"], correct: 1 },
      { id: 2, text: "Единица измерения силы в СИ — это...", options: ["Джоуль", "Ватт", "Ньютон", "Паскаль"], correct: 2 },
      { id: 3, text: "Чему равна скорость света в вакууме?", options: ["300 км/с", "300 000 км/с", "30 000 км/с", "3 000 000 км/с"], correct: 1 },
      { id: 4, text: "Какой прибор измеряет атмосферное давление?", options: ["Амперметр", "Барометр", "Вольтметр", "Манометр"], correct: 1 },
      { id: 5, text: "Формула скорости — это...", options: ["v = m·a", "v = s/t", "v = F/m", "v = P/t"], correct: 1 },
      { id: 6, text: "Что такое инерция?", options: ["Сила притяжения", "Свойство тела сохранять состояние покоя или движения", "Мера тяжести тела", "Взаимодействие тел"], correct: 1 },
      { id: 7, text: "Единица измерения работы — это...", options: ["Ньютон", "Ватт", "Джоуль", "Паскаль"], correct: 2 },
      { id: 8, text: "Что происходит с телом при нагревании?", options: ["Сжимается", "Расширяется", "Не изменяется", "Темнеет"], correct: 1 },
      { id: 9, text: "Первый закон Ньютона называется законом...", options: ["Всемирного тяготения", "Инерции", "Сохранения энергии", "Архимеда"], correct: 1 },
      { id: 10, text: "Чему равно ускорение свободного падения на Земле?", options: ["5 м/с²", "9,8 м/с²", "15 м/с²", "3,7 м/с²"], correct: 1 },
    ],
  },
  {
    id: 5,
    ...
    timeLimit: 240,
    questions: [
      { id: 1, text: "Основная единица живого организма — это...", options: ["Атом", "Молекула", "Клетка", "Орган"], correct: 2 },
      { id: 2, text: "Процесс образования органических веществ из воды и CO₂ на свету называется...", options: ["Дыхание", "Фотосинтез", "Размножение", "Пищеварение"], correct: 1 },
      { id: 3, text: "Какой орган отвечает за кровообращение?", options: ["Лёгкие", "Печень", "Сердце", "Почки"], correct: 2 },
      { id: 4, text: "Хлорофилл содержится в...", options: ["Корне", "Хлоропластах", "Митохондриях", "Вакуолях"], correct: 1 },
      { id: 5, text: "Как называется наука о растениях?", options: ["Зоология", "Микробиология", "Ботаника", "Анатомия"], correct: 2 },
      { id: 6, text: "Сколько царств живой природы выделяют в биологии?", options: ["2", "3", "5", "10"], correct: 2 },
      { id: 7, text: "Что такое фотосинтез?", options: ["Разложение органики", "Синтез органики на свету", "Поглощение воды", "Выделение CO₂"], correct: 1 },
      { id: 8, text: "Какая система органов отвечает за дыхание?", options: ["Кровеносная", "Нервная", "Дыхательная", "Пищеварительная"], correct: 2 },
      { id: 9, text: "Самая крупная кость человека — это...", options: ["Позвонок", "Ребро", "Бедренная кость", "Череп"], correct: 2 },
      { id: 10, text: "Какой пигмент придаёт листьям зелёный цвет?", options: ["Каротин", "Хлорофилл", "Антоциан", "Меланин"], correct: 1 },
    ],
  },
];
